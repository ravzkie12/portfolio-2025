			...
			<div className="max-w-2xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-6">
					...
					<div className="flex items-center justify-center gap-2 text-gray-300">
						...
						<span>Panabo, Davao</span>
					</div>

					{/* Contact Buttons */}
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:ortizraven92@gmail.com"
					...
					<div className="flex justify-center gap-6">
						<a href="https://github.com/ravzkie12" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
