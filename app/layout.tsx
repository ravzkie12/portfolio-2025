...
export const metadata: Metadata = {
	...
	authors: [{ name: 'Raven Ortiz' }],
	creator: 'Raven Ortiz',
	openGraph: {
		title: 'Raven Ortiz - Developer Portfolio',
		...
		siteName: 'Raven Ortiz - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Raven Ortiz - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
